<template>
  <section class="content">
    ...
    <div class="container">
       <h1 class="display-4">Items(SKU)</h1>
       <br>
  ...
  <!-- <div class="card">
    ...
    <table class="table">
      ...
      <tbody>
        <template v-for="sam in filteredRows2">
        <tr :key="sam.id">
          ...
          <!-- {{sam.description | truncate(30, '...')}} -->
          <td v-html="highlightMatches(sam.category.name)"></td>
          <!-- <td v-html="highlightMatches(sam.serialno)"></td> -->
          ...
          <!-- <tr v-if="opened.includes(sam.id)" :key="k" style="background-color:#f2f3f4;"> 
              
              <td>
                   <b-card> 
                        <table class="table">
                            <thead>
                                <th><small>Serial Numbers</small></th>
                            </thead>
                            <tbody>
                                <tr >
                                    <td class="subTableVals">{{x.id}}</td>
                                    <td class="subTableVals">{{x.order_id}}</td>
                                    <td><small>0156465465</small></td>
